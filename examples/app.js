...
// const beta = 1 / (0.3 ** 2)
// const alpha = 0.005
// const predictedY = BLR(trainX,trainY,testX,testY).train().test();
// const predictedY = BLR(trainX,trainY,testX,testY).useBasisFn("polynomial").train().test();
...
// const lbf = BLR(trainX,trainY,testX,testY).learnBasisFn().train().test();
